            ...
            link.children ? (
              ...
              <div key={link.label} className="relative">
                <button
                  ...
                  className="relative flex items-center gap-1 text-sm font-medium text-gray-600 hover:text-[#278dcd] transition-colors duration-200 group"
                >
                  {link.label}
                  {/* Chevron */}
                  <svg
                ...
                {/* Dropdown panel */}
                <div
                  className={`absolute top-full left-1/2 -translate-x-1/2 mt-3 w-48 bg-white rounded-xl border border-gray-100 shadow-lg overflow-hidden transition-all duration-200 origin-top ${
                  ...
                  <div className="py-1">
                    {link.children.map((child) => (
                      <a
                        ...
                        className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-600 hover:text-[#278dcd] hover:bg-[#278dcd]/5 transition-colors duration-150"
                      >
                        <span className="w-1 h-1 rounded-full bg-[#278dcd]/50 flex-shrink-0" />
                        {child.label}
                      </a>
                    ))}
                  </div>
              ...
              <div key={link.label}>
                ...
                {link.children.map((child) => (
                  <a
                    ...
                    className="pl-4 py-2.5 text-sm text-gray-500 hover:text-[#278dcd] border-b border-gray-50 last:border-b-0 transition-colors duration-200 flex items-center gap-2"
                  >
                    <span className="w-1 h-1 rounded-full bg-[#278dcd]/50" />
                    {child.label}
                  </a>
                ))}
              </div>
